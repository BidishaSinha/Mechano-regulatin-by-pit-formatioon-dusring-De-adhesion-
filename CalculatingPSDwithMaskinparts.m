%% inputs
clear
d_name='/Users/bidishasinha/Dropbox (Personal)/matlab_iicb/CPGA_001_02'; % PLEASE KEEP SINGLE INVETED COMMAS NOT DOUBLE
...
%% Make a mask 
cd(old_dir)
nobj= 3; % No. of objects to mask out separately
clear BW
clear BWs
for it=1:nobj
    figure(1)
...
% cd(old_dir)
sps = 50; cf = 5.065;
%xboff = 770; yboff = 124; M1 = 6; N1 = 6;
wannasave = 'y'; order = 32;
dname=d_name;
directoryname=d_name;
rem1= 'cell';
psdIMcovMaskpixelreadJG1024Long(d_name,d_name, BW, sps, cf, order, wannasave, rem1) % remember 'cell' not "cell"
toc
%% 
%psdIMcovMaskpixelread(dname, directoryname, BW, sps, conv, order, wannasave, rem)
cd(old_dir)
